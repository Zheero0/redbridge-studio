...
import { Calendar, Clock, Package, User, Mail, Phone, ArrowRight } from "lucide-react"
                  ...
                  <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg h-full flex flex-col">
                    <CardHeader>
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="text-xl font-bold text-primary">£{booking.package?.price}</div>
                      </div>
                    ...
                    <CardContent className="flex-1 flex flex-col justify-between">
                      <div className="space-y-3 mb-4">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-muted-foreground capitalize">{booking.timeSlot}</span>
                        </div>
                      </div>

                      <Link href={`/panel-manager-v1/${booking.id}`} className="block">
